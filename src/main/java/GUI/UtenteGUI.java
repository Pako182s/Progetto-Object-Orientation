...
/**
 * Classe GUI per l'interfaccia dell'utente partecipante all'hackathon.
 * Fornisce accesso alle funzionalità principali come gestione team,
 * visualizzazione informazioni evento, editing documenti e consultazione classifica.
 *
...
public class UtenteGUI {
    ...
    /**
     * Costruttore della classe UtenteGUI.
     * Inizializza l'interfaccia utente, personalizza il messaggio di benvenuto
     * e configura tutti i listener per le funzionalità disponibili all'utente.
     *
     ...
     * @param nomeUtente il nome dell'utente autenticato
     */
